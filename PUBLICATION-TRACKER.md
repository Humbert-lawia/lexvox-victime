...
| 25 | E | feuille | Comment se passe l'expertise medicale : deroule etape par etape | https://lexvox-victime.com/actualites/deroule-expertise-medicale | **prêt à publier** — NW **85** (seuil atteint, cf. skill nw-optimisation, run de référence 62→85). preflight/qa/qa_article_aivf tous verts. Publication Sanity **bloquée uniquement par l'accès réseau à *.sanity.io de l'environnement**, pas par une décision éditoriale. |
